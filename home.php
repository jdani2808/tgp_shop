 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">TGPagpagaling Ng Pilipinas</h1>
            <p class="lead fw-normal text-white-50 mb-0">Looking for your medicines? Shop Now!</p>
        </div>
    </div>
</header>
<!-- Section-->
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row gx-5 gx-lg-5 row-cols-md-5 row-cols-xl-5 justify-content-center">
            <?php 
